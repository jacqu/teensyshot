/*
 *  ESCPID:   PID control of up to 6 ESCs using DSCHOT
 *
 *  Authors:  Arda Yigit and Jacques Gangloff
 *  Date:     May 2019
 */
...
#define DSHOT_LENGTH            16          // Number of bytes in a DSHOT transaction

// Global variables

DMAChannel dshot_dma;
volatile uint16_t dshot_dma_source[DSHOT_DMA_LENGTH];
volatile uint16_t dshot_data_to_send;
